...
export default function EntryInfo(){
    ...
    return(
        ...
        <div className="leftSide self-center mx-auto flex flex-col gap-10 ">
            <p className="font-bold text-3xl drop-shadow-md">Elevate Your Shopping
            ...
            <Link to="/shopping" className="drop-shadow-md cursor-pointer md:w-2/5 py-2 px-4 text-lg font-bold border-2 rounded-xl  bg-blue-500 text-white text-center" >
            Shop Now!</Link>
        </div>
